...
namespace OccaSoftware.SuperSimpleSkybox.Editor
{
    ...
    {
        private static readonly string[] ColorModeNames = { "Day And Night Colors", "Constant" };
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            void DrawCommonProperties()
            {
                ...
                constantColorMode.floatValue = EditorGUILayout.Popup(
                    "Color Mode",
                    (int)constantColorMode.floatValue,
                    ColorModeNames
                );
            ...
            void DrawStarProperties()
            {
                ...
                if (starsEnabled.floatValue == 1.0f)
                {
                    ...
                    proceduralStarsEnabled.floatValue = EditorGUILayout.Toggle(
                        EditorGUIUtility.TrTextContent("Procedural Stars Enabled"),
                    ...
                    textureStarsEnabled.floatValue = EditorGUILayout.Toggle(
                        EditorGUIUtility.TrTextContent("Star Texture Enabled"),
            ...
            void DrawCloudProperties()
            {
                ...
                if (cloudsEnabled.floatValue == 1.0f)
                {
                    ...
                    if (cloudTexture.textureValue != null)
                    {
                        ...
                        DrawIntegerProperty(cloudIterations, EditorGUIUtility.TrTextContent("Iterations"), 1, 4);
                        if (cloudIterations.floatValue >= 2)
                        {
                            EditorGUI.indentLevel++;
                            e.ShaderProperty(cloudGain, "Gain");
                            DrawIntegerProperty(cloudLacunarity, EditorGUIUtility.TrTextContent("Lacunarity"), 2, 5);
                            EditorGUI.indentLevel--;
                        }
                        EditorGUI.indentLevel--;
