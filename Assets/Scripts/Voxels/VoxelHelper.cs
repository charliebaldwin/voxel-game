...
public static class VoxelHelper
{
    ...
    public static Vector3Int[] VectorDirections = new Vector3Int[6] { Vector3Int.left, Vector3Int.right, Vector3Int.down, Vector3Int.up, Vector3Int.back, Vector3Int.forward };
    public static OrthoNormal[] OrthoDirections = new OrthoNormal[6] { OrthoNormal.left, OrthoNormal.right, OrthoNormal.down, OrthoNormal.up, OrthoNormal.back, OrthoNormal.forward };
