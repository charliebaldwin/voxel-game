...
SubShader {
	...
	Pass {
		...
		struct pixel_t
		{
            ...
            float4 canvasPos        : TEXCOORD6;        // Soft Mask injection
		};
		...
		pixel_t VertShader(vertex_t input)
		{
            ...
            // Pass unclipped Canvas Position to Soft Mask
            output.canvasPos = input.position;
		...
		fixed4 PixShader(pixel_t input) : SV_Target
		{
			...
			// Inject Soft Mask over the composited TMP result
            faceColor *= SoftMask_GetAlpha(input.canvasPos);
